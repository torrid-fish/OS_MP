...
public:
    ...
    bool isDirectory;              // Is this file a directory?
...
public:
    ...
    void Print(int depth, bool printSector); 
                  // Verbose print of the contents
                  //  of the directory -- all the file
                  //  names and their contents.

    // Return table[i]
    DirectoryEntry getTableEntry(int i) { return table[i]; }

    // Return table[FindIndex(name)]
    DirectoryEntry getTableEntry(char* name) { return table[FindIndex(name)]; }
private:
    /*
		MP4 Hint:
