...
public:
	...
	void Print(int depth, int sector, bool printSector); // Print the contents of the file.
...
private:
	...
	*/
	...
	int headerSectorsL1[NumDirect]; 
	int headerSectorsL2[NumDirect][32];
	int headerSectorsL3[NumDirect][32][32];
	int dataSectors[NumDirect][32][32][32]; // Disk sector numbers for each data block in the file
};
#endif // FILEHDR_H
